...
let Initialize () = 
    Registrations <- [|
        ...
        new PokeRegistration("Cyndaquil", 3, 4, Guid.Parse("d9e51bf3-fa8c-46ab-a85a-e1036f17daaa"))
        new PokeRegistration("Totodile", 4, 0, Guid.Parse("14545496-3219-4fa0-98cb-ed691df0a37c"))
